...
def homepage():
    ...
    return render_template('homepage13.html', content=content)
...
def add_post_page():
    ...
    return render_template('addpost2.html', content=content)
...
def comment_page():
    ...
    return render_template('comment2.html', comments=comments)
